...
export function OwnerLayout({ children }: OwnerLayoutProps) {
  ...
  const navigation = [
    { name: t('nav.dashboard'), href: '/proprietaire/tableau-de-bord', icon: LayoutDashboard },
    { name: t('nav.reservations'), href: '/proprietaire/reservations', icon: ClipboardList },
    { name: t('nav.pets'), href: '/proprietaire/mes-animaux', icon: PawPrint },
    { name: t('nav.favorites'), href: '/proprietaire/favoris', icon: Heart },
    { name: t('nav.settings'), href: '/proprietaire/parametres', icon: Settings },
  ];
